...
<head>
    ...
    <!--== Icofont Icon CSS ==-->
    <link href="/users/assets/css/icofont.css" rel="stylesheet" />
    <!--== Swiper CSS ==-->
    <link href="/users/assets/css/swiper.min.css" rel="stylesheet" />
    <!--== Fancybox Min CSS ==-->
    <link href="/users/assets/css/fancybox.min.css" rel="stylesheet" />
    <!--== Aos Min CSS ==-->
    <link href="/users/assets/css/aos.min.css" rel="stylesheet" />
...
<body>
                        ...
                        <div class="header-align">
                            <div class="header-align-start">
                                <div class="header-logo-area">
                                    <a href="index.html">
                                        <img class="logo-main" src="/users/assets/img/logo-light.png" alt="Logo" />
                                        <img class="logo-light" src="/users/assets/img/logo-light.png" alt="Logo" />
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <ul class="main-menu nav">
                                        ...
                                        <li class="has-submenu"><a href="#/"><span>Candidates</span></a>
                                            <ul class="submenu-nav">
                                                ...
                                                <li><a href="candidate-details.html"><span>Candidate Details</span></a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="header-align-end">
                                <div class="header-action-area">
                                    <a class="btn-registration" href="{{ route('register') }}"><span>+</span> Daftar Sekarang</a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="widget-item widget-about">
                                <div class="widget-logo-area">
                                    <a href="index.html">
                                        <img class="logo-main" src="/users/assets/img/logo-light-theme.png"
                                            alt="Logo" />
                                    </a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="footer-bottom-content">
                                <p class="copyright">© 2021 Finate. Made with <i class="icofont-heart"></i> by <a
                                        target="_blank"
    ...
    <script src="/users/assets/js/modernizr.js"></script>
    <!--=== jQuery Min Js ===-->
    <script src="/users/assets/js/jquery-main.js"></script>
    <!--=== jQuery Migration Min Js ===-->
    <script src="/users/assets/js/jquery-migrate.js"></script>
    ...
    <script src="/users/assets/js/fancybox.min.js"></script>
    <!--=== jQuery Aos Min Js ===-->
    <script src="/users/assets/js/aos.min.js"></script>
    <!--=== jQuery Counterup Min Js ===-->
    <script src="/users/assets/js/counterup.js"></script>
    <!--=== jQuery Waypoint Js ===-->
    <script src="/users/assets/js/waypoint.js"></script>
